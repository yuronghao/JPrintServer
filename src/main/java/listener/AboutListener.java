...
import bean.VersionSummary;
import cn.hutool.http.HttpUtil;
import cn.hutool.log.Log;
import cn.hutool.log.LogFactory;
import com.alibaba.fastjson.JSON;
import com.emi.ui.ConstantsUI;
...
public class AboutListener {
    ...
    public static void addListeners() {
        MainWindow.mainWindow.getCompanyLable().addMouseListener(new MouseAdapter() {
            @Override
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                MainWindow.mainWindow.getCompanyLable().setCursor(new Cursor(Cursor.HAND_CURSOR));
            }
