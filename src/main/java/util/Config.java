...
public class Config {
    ...
    private String sntext; //物料名称

    private String sncode;//物料编码

    private String standard;//物料规格

    private String printserver;//打印机名称
    ...
    private Config() {
        ...
        //存放待打印PDF文件夹
        File PrintPDFDir = new File(SystemUtil.configHome + "PrintPDF" + File.separator);
        PrintPDFDir.mkdirs();

        //已打印的PDF文件夹
        File OldPrintPDFDir = new File(SystemUtil.configHome + "OldPrintPDFDir" + File.separator);
        OldPrintPDFDir.mkdirs();
    ...
    private void originInit() {
        ...
        //2018-5-25
        props.setProperty("custom.sntext", "测试物料");
        props.setProperty("custom.sncode", "1231566");
        props.setProperty("custom.standard", "规格1");
        props.setProperty("custom.printserver", "测试打印机");
    ...
    public String getSntext() {
        return props.getProperty("custom.sntext");
    }

    public void setSntext(String sntext) {
        props.setProperty("custom.sntext", sntext);
    }

    public String getSncode() {
        return props.getProperty("custom.sncode");
    }

    public void setSncode(String sncode) {
        props.setProperty("custom.sncode", sncode);
    }

    public String getStandard() {
        return props.getProperty("custom.standard");
    }

    public void setStandard(String standard) {
        props.setProperty("custom.standard", standard);
    }

    public String getPrintserver() {
        return props.getProperty("custom.printserver");
    }

    public void setPrintserver(String printserver) {
        props.setProperty("custom.printserver", printserver);
    }
